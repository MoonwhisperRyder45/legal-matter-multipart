...
> Design notes for **legal-matter-multipart** — a runnable go example that Go multipart intake flow for signed legal matter documents and deadline follow-up.
...
- **Feature code** — the actual task: legal-matter-intake.
